...
const I = {
  ...
  // Commission icons
  percent:     "M19 5L5 19M9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zm11 11a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z",
  wallet:      "M21 12V7H5a2 2 0 0 1 0-4h14v4M3 5v14a2 2 0 0 0 2 2h16v-5M3 5a2 2 0 0 0-2 2v3h20M23 12h-4a2 2 0 0 0 0 4h4v-4z",
};
...
export default function Sidebar() {
  ...
  // active() matches exact paths and also handles sub-paths
  // e.g. /commissions/settings and /commissions/earnings
      ...
      <nav style={{ flex: 1, padding: "6px 8px", overflowY: "auto" }}>
        ...
        {role === "Owner" && <>
          ...
          <NavItem
            ...
            active={active("/commissions/settings")}
          />
          <NavItem
            to="/commissions/earnings"
            icon={I.wallet}
            label="Staff Earnings"
            active={active("/commissions/earnings")}
          />
