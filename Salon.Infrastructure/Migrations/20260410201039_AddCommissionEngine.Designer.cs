...
namespace Salon.Infrastructure.Migrations
{
    ...
    [Migration("20260410201039_AddCommissionEngine")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Salon.Domain.Entities.Commission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Salon.Domain.Entities.CommissionRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Salon.Domain.Entities.CommissionTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Salon.Domain.Entities.StaffSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Salon.Domain.Entities.CommissionRule", b =>
                {
                    b.HasOne("Salon.Domain.Entities.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("Salon.Domain.Entities.CommissionTier", b =>
                {
                    b.HasOne("Salon.Domain.Entities.CommissionRule", "CommissionRule")
                        .WithMany("Tiers")
